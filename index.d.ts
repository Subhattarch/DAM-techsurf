...
interface JQuery {
     ...
     */
    clearCanvas(rect?: Partial<JCanvasRect>): this;
    ...
    drawArc(def: {
        ...
        draggable?: boolean;
        fromCenter?: boolean;
        drag?: (layer: {x: number, y: number, radius: number}) => void,
        remove?: (layer: {x: number, y: number}) => void
    })
    ...
    drawImage(def: {
        ...
        width?: number,
        height?: number,
        drag?: (layer: {x: number, y: number}) => void,
        remove?: (layer: {x: number, y: number}) => void,
        load?: () => void
    }): this,
    removeLayer(name: number | string): JQuery,
    drawLayers(): JQuery
}
